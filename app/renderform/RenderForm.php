...
//echo "</div>";
	echo '<div class="input-block">
        ...
        echo '<input class="__select_drop inputF" id="'.$element->name.'" name="'.$element->exname.'" autocomplete="off" required=""';
		if ($element->selectedoption!='') {
				echo ' value="'.$element->selectedoption.'"';
				$curr_option = $element->selectedoption;
		}else{
...
//echo "</div>";
	echo '<div class="input-block">
            ...
            echo '<div class="qs_sub"></div></div></div>'."\n";
            echo '<div class="input-control outerInFoc">';
	echo '<input class="__select_drop inputF" autocomplete="off" required="" name="'.$element->exname.'"';
	if ($element->selectedoption!='') {
			echo ' value="'.$element->selectedoption.'"';
			$curr_option = $element->selectedoption;
	}else{
