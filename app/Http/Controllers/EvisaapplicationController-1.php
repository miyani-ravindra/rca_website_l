...
public function evisahongkongform(Request $request){
	...
	// echo "<pre>";print_r($occupation_arr);exit;
	

	//RCAV1-25 - START
	if(isset($ccode) && $ccode === "srilanka"){

		return view('evisaapplication/evisasrilanka', compact('ccode','getpostdata','getservice','getmarital','data_name','country_arr','occupation_arr'));
