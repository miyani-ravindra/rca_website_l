                    ...
                    <div class="paddingtb_50">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-md-12 text-center">
                                        <div class="__proceed">
                                            <form name="lounge_service_form" id="lounge_service_form" action="step3" method="post">
                                                ...
                                                <input type="hidden" name="lounge_child_age_array" id="lounge_child_age_array" value="{{serialize($lounge_child_age_array)}}">
                                                ...
                                                <input type="hidden" name="layover_hrs" id="layover_hrs" value="{{isset($layover_hrs) ? $layover_hrs :''}}">
