...
@section('content')
   <div class="clearfix"></div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="paddingtb_50">
                        <form method="post" id="frm_srilanka_visa_application" name="frm_srilanka_visa_application" action="{{ URL::to('/').'/srilanka-evisa-application'}}">
                            <input type="hidden" name="residing_code" id="residing_code" value="{{$postData['residing_code']}}">
                            <input type="hidden" name="country_code" id="country_code" value="{{$postData['country_code']}}">
                            <ul class="tabs_z">
                                <li class="__current">
                                    <a href="{{URL::to('/')}}">
    ...
    <!-- <iframe src="#" id="utm_frame" style="height:200px;width:300px;display: none;"></iframe> -->
<script type="text/javascript">
// Put the variable names into the hidden fields in the form.
// var utm_url = "{{$postData['utm_url']}}";
// if(utm_url != ''){
//     document.getElementById('utm_frame').src = utm_url;
// }
</script>    
