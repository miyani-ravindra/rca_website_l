            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="paddingtb_50">
                        <form method="post" id="frmevisatype" action="{{URL::to('/')}}/booking/b2b-basic-details/{{$getpostdata['residing_code']}}">
                            ...
                            <div class="__form_wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center paddingtb_20">
                                        <button type="submit" class="__btn __btn_next" name="btn_booking_verify" id="btn_booking_verify" >SUBMIT</button>
                                    </div>
                                </div><!-- row end -->
                            </div><!-- Form wrapper -->
                        </div><!-- Tab Content End -->
