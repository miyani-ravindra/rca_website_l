      ...
      <div class="row">
         <div class="col-md-12">
            <div class="paddingtb_50">
               <form method="post" action="{{URL::to('/')}}/booking/evisa-type/{{$postData['residing_code']}}" id="frmevisastep2" name="frmevisastep2" enctype='multipart/form-data'>
                                       ...
                                       <div class="input-control">
                                          <div class="__document_upload_box">
                                            ...
                                            <div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
                                                <img src="{{URL::to('/')}}/svg/thumbnail-1.svg" alt="...">
                                            </div> 
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 150px; max-height: 150px;"></div>   
                                            <!-- <div class="fileinput-preview thumbnail" id="div_front_thumb">
                                                <div class="doc-head">Colored frontpage of valid passport <span class="_astrik">*</span></div>
                                            </div> --> 
                                            <!--<div>
                                            ...
                                            <!--<div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 150px; height: 150px;">
                                                <img src="{{URL::to('/')}}/svg/thumbnail-2.svg" alt="...">
                                            </div>
                                            <div class="fileinput-preview fileinput-exists thumbnail" style="max-width: 150px; max-height: 150px;"></div>    
                                            <!-- <div class="fileinput-preview thumbnail" id="div_photo_thumb">
                                                    <div class="doc-head">Passport Size photograph <span class="_astrik">*</span></div>
                                                </div> --> 
                                            <!--<div>
                                            <span class="btn-file"><span class="fileinput-new">Upload</span><span class="fileinput-exists">Change</span>
