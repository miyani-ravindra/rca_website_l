      ...
      <div class="row">
         <div class="col-md-12">
            <div class="paddingtb_50">
               <form method="post" id="frmevisadetails" name="frmevisadetails" action="{{URL::to('/')}}/booking/excel">
                                 ...
                                 <div class="upform-main">
                                    ...
                                    <div class="input-block">
                                       ...
                                       <div class="input-control outerInFoc">
                                          ...
                                          <input type="hidden" name="pres_country" required="" class="inputH" value="">
                                          <div class="press_enter"></div>
                                        </div>
                                    ...
                                    <div class="input-block">
                                       <div class="labels">
                                          <div class="qs_list"></div>
                                          <div class="qs_body">
                                             Reference Name in {{$getpostdata['residing_in']}}
                                             <span class="strike">*</span>
                                             <div class="qs_sub"></div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="input-block">
                                       <div class="labels">
                                          <div class="qs_list"></div>
                                          <div class="qs_body">
                                             Address in {{$getpostdata['residing_in']}}
                                             <span class="strike">*</span>
                                             <div class="qs_sub"></div>
                                          </div>
                                       </div>
                                    ...
                                    <div class="input-block">
                                       <div class="labels">
                                          <div class="qs_list"></div>
                                          <div class="qs_body">
                                             Phone No in {{$getpostdata['residing_in']}}
                                             <span class="strike">*</span>
                                             <div class="qs_sub"></div>
                                          </div>
                                       </div>
