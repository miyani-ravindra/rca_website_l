            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="paddingtb_50">
                        <form method="post" id="frmevisatype" action="{{URL::to('/')}}/booking/b2b-basic-details/{{$getpostdata['residing_code']}}" enctype='multipart/form-data'>
                            ...
                            <input type="hidden" name="doc_route" id="doc_route" value="{{URL::to('/')}}/booking/b2b-service-document/{{$getpostdata['residing_code']}}">
                            <input type="hidden" name="form_route" id="form_route" value="{{URL::to('/')}}/booking/b2b-basic-details/{{$getpostdata['residing_code']}}">
                            ...
                            <div class="__form_wrapper">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-center paddingtb_20">
                                        <button type="submit" class="__btn __btn_next" name="btn_evisa_type" id="btn_evisa_type" disabled="">SUBMIT</button>
                                    </div>
                                </div><!-- row end -->
                            </div><!-- Form wrapper -->
                        </div><!-- Tab Content End -->
