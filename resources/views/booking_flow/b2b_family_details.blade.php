   ...
   <div class="row">
      <div class="col-md-12">
         <div class="paddingtb_50">
            <form method="post" id="frmevisafamilyform" name="frmevisafamilyform" action="{{URL::to('/')}}/booking/visa-details/{{$getpostdata['residing_code']}}">
                              ...
                              <div class="upform">
                                 <div class="upform-main">
                                    ...
                                    <div class="input-block spouse_div">
                                       ...
                                       <div class="input-control outerInFoc">
                                         ...
                                         <input type="text" name="spouse_previous_nationality_text" class="__select_drop inputF" autocomplete="off" required="" />
                                          ...
                                          <input type="hidden" name="spouse_previous_nationality" class="inputH" value="" required="">
                                          <div class="press_enter"></div>
                                        </div>
                                        <div class="outerclick"></div>
                                    </div>
                                    ...
                                    <div class="input-block" >
                                       ...
                                       <div class="input-control">
                                          <input type="text" name="empphone" value="" required="">
                                          <div class="press_enter"></div>
                                       </div>
                                    </div>
                                    <div class="input-block" >
