        ...
        <div class="container container-sm paddingtb_50">
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <p class="__heading_para">Exclusive services for Indian Citizens with Valid US, UK and Schengen Visa.</p>
                </div>
                            ...
                            <div class="__radio_row">
                                <div class="col-md-6">
                                    <div class="group-radio">
                                        <input id="s1" name="service_type" type="radio" class="orbit" value="turkey_30_day_tou">
                                        <label for="s1">30 Days Tourist eVisa</label>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="group-radio">
                                        <input id="s2" name="service_type" type="radio" class="orbit" value="turkey_30_day_bus">
