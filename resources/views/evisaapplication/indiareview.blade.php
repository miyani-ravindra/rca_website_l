                     ...
                     <div class="row">
                        <div class="col-md-12">
                           ...
                           <div class="__hgk_rev_header">
                                ...
                                <button type="button" class="__btn" id="btn_cancel">Cancel</button>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-12">
                            ...
                            <div class="__fm_box __app_form">
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        ...
                                        <input type="text" name="arrival_date" value="{{$qry['arrival_date']}}" class="datepicker" id="arrival_date" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        <label>Port of  Arrival</label>
                                        <select id="airport_code" class="__select" name="airport_code" required="">
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        ...
                                        <select id="airport_code" class="__select" name="pres_country" required="">
                                             @foreach($airport_arr as $key=>$val)
                            ...
                            <div class="__fm_box __app_form">
                                ...
                                <div class="col-md-4">
                                	<div class="__select_box">
                                        ...
                                        <select id="gender" class="__select" name="gender" required="" readonly> 
                                            <option {{$qry['gender'] == "M" ? "selected" : ''}} value="M">MALE</option>
                                            <option  {{$qry['gender'] == "F" ? "selected" : ''}} value="F">FEMALE</option>
                                            <option {{$qry['gender'] == "T" ? "selected" : ''}} value="T">TRANSGENDER</option>
                                        </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        ...
                                        <select id="" class="__select" name="nationality" required="" readonly>
                                             @foreach($getcountry as $val)
                                             <option value="{{$val->country_id}}" {{$qry['nationality_id'] == $val->country_id ? "selected" : ''}}>{{$val->country_name}}</option>
                                             @endforeach
                                          </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                ...
                                <div class="__fm_box __app_form">
                                    <div class="col-md-12">
                                    <p class="__form_notes">Passport Details</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                ...
                                <div class="col-md-4" id="prev_passport_country_issue">
                                    <div class="__select_box">
                                        ...
                                        <select id="" class="__select" name="prev_passport_country_issue" readonly>
                                             <option></option>
                                             @foreach($getcountry as $val)
                                ...
                                <div class="col-md-4" id="other_ppt_nationality">
                                    <div class="__select_box">
                                        ...
                                        <select id="" class="__select" name="other_ppt_nationality" readonly>
                                             <option></option>
                                             @foreach($getcountry as $val)
                            ...
                            <div class="__fm_box __app_form">
                                <div class="col-md-12">
                                    <p class="__form_notes">Present Address Details</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                ...
                                <div class="col-md-12">
                                    <p class="__form_notes">Permanent Address Details</p>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>House No./Street</label>
                                        <input type="text" name="perm_addr1" value="{{$qry['perm_address1']}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>Village/Town/City</label>
                                        <input type="text" name="perm_addr2" value="{{$qry['perm_address2']}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>State/Province/District</label>
                                        <input type="text" name="perm_addr3" value="{{$qry['perm_address3']}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="__fm_box __app_form">
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        ...
                                        <select id="" class="__select" name="mstatus" required="">
                                ...
                                <div class="col-md-12 spouse_dtl">
                                    <p class="__form_notes">Spouse's Details</p>
                                </div>
                                <div class="col-md-4 spouse_dtl">
                                    <div class="__app_input">
                                ...
                                <div class="col-md-4 spouse_dtl">
                                    <div class="__select_box">
                                        <label>Previous Nationality</label>
                                        <select id="" class="__select" name="spouse_previous_nationality">
                                            <option></option>
                                             @foreach($getcountry as $val)
                                ...
                                <div class="col-md-4" id="grandparent_details">
                                    <div class="__app_input">
                                        ...
                                        <input type="text" name="grandparent_details" value="{{$qry['grandparent_details']}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="__fm_box __app_form">
                                ...
                                <div class="col-md-4" id="if_prof_other">
                                    <div class="__app_input">
                                        <label>Occupation (If other)</label>
                                        <input type="text" name="if_prof_other" value="{{$qry['if_occ_other']}}" />
                                    </div>
                                </div>
                                <div class="col-md-4" id="occ_flag">
                                    <div class="__select_box">
                                        <label>Specify below occupation details of</label>
                                        <select class="__select" name="oth_occ_flag">
                                             <option value="">Select...</option>
                                             <option value="F" {{(!empty($qry['oth_occ_flag']) && $qry['oth_occ_flag']=="F"?"selected":NULL)}}>Father</option>
                                             <option value="S" {{(!empty($qry['oth_occ_flag']) && $qry['oth_occ_flag']=="S"?"selected":NULL)}}>Spouse</option>
                                          </select>
                                          <i class="fa fa-angle-down"></i>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        <label>Previous Occupation(If Any)</label>
                                        <select id="" class="__select" name="prev_occ" required="" readonly>
                                             @foreach($getpropfession as $val)
                            ...
                            <div class="__fm_box __app_form">
                                ...
                                <div class="col-md-4 pre_visit_div">
                                    <div class="__select_box">
                                        ...
                                        <select id="" class="__select" name="old_visa_type_id" readonly>
                                            <option></option>
                                ...
                                <div class="col-md-4 pre_visit_div">
                                    <div class="__app_input">
                                        <label>Date of Issue</label>
                                        <input type="text" name="oldvisaissuedate" value="{{isset($qry['oldvisaissuedate'])?$qry['oldvisaissuedate']:NULL}}" id="oldvisaissuedate" class="datepicker" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>{{$qry['residing_in']}} Reference Name</label>
                                        <input type="text" name="nameofsponsor_msn" value="{{$qry['nameofsponsor_msn']}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>{{$qry['residing_in']}} Reference Address</label>
                                ...
                                <div id="saarc_form_div">
                                    ...
                                    <div class="col-md-12 fieldGroup" id="saarc_form_div">
                                             <div class="col-md-12 paddingtb_20">
                                                <a href="javascript:void(0)" class="saarc_add_button" style="display: none;"><span class="__add_circle">
                                                <i class="fa fa-plus"></i>
                                                </span></a>
                                             </div>
                                             <!-- <input type="hidden" id="div_number" name="div_number" value="1"> -->
                                                @if(isset($saarc_details))
                                                  @foreach($saarc_details as $key=>$val)
                                                  @if(!empty($val[2]))
                                                    @if($key==0)
                                                        <div class="col-md-12">
                                                    <div class="col-md-4">
                                                        <div class="__select_box">
                                                            <label>Country</label>
                                                            <select id="" class="__select child-input-class" name="saarcCountry[]" required="">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="__app_input">
                                                            <label>Year</label>
                                                            <input type="text" class="child-input-class" name="saarcYear[]" value="{{$val[1]}}" required="" />
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2">
                                                        <div class="__app_input">
                                                            <label>No of Visits</label>
                                                            <input type="text" class="child-input-class" name="saarcVisitNo[]" value="{{$val[2]}}" required="" />
                                                        </div>
                                                    </div>
                                                    </div>
                                                    @else
                                                    <div class="col-md-12 child_input_{{$key}}">
                                                    <div class="col-md-4">
                                                        <div class="__select_box">
                                                            <label>Country</label>
                                                            <select id="" class="__select child-input-class" name="saarcCountry[]" required="">
                                                    ...
                                                    <div class="col-md-2"><a href="javascript:void(0)" class="saarc_remove_exit" onclick="removediv({{$key}})" id="div_minus" style="display: none;"><span class="__add_circle"><i class="fa fa-minus"></i></span></a>
                                                    </div>
                                                    </div>
                                                    @endif
                                                    @endif
                                                ...
                                                <div class="col-md-12">
                                                  <div class="col-md-4">
                                                    <div class="__select_box">
                                                        <label>Country</label>
                                                        <select id="" class="__select child-input-class" name="saarcCountry[]">
                                                            <option value="">Select Country</option>
                                                            @foreach($getsaarccountry as $v)
                                                ...
                                                <div class="col-md-4">
                                                    <div class="__select_box">
                                                        <label>Year</label>
                                                        <select class="__select child-input-class" name="saarcYear[]">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="__app_input">
                                                        <label>No of Visits</label>
                                                        <input type="text" class="child-input-class" name="saarcVisitNo[]"/>
                                                    </div>
                                                </div>
                                                </div>
                                                @endif
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        <label>State</label>
                                        <select id="" class="__select" name="service_req_short_medical[hospital_state]" >
                                            <option></option>
                                            @foreach($getstate as $v)
                                            <option value="{{$v->state_id}}" {{$service_purpose->service_req_short_medical->hospital_state == $v->state_id ? "selected" : ''}}>{{$v->state_name}}</option>
                                            @endforeach
                                        </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        <label>State</label>
                                        <select id="" class="__select" name="service_req_short_yoga[yoga_institute_state]" >
                                            <option></option>
                                            @foreach($getstate as $v)
                                            <option value="{{$v->state_id}}" {{$service_purpose->service_req_short_yoga->yoga_institute_state == $v->state_id ? "selected" : ''}}>{{$v->state_name}}</option>
                                            @endforeach
                                        </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="__select_box">
                                        <label>State</label>
                                        <select id="" class="__select" name="service_req_meeting_frend[frnd_state]" >
                                            <option></option>
                                            @foreach($getstate as $v)
                                            <option value="{{$v->state_id}}" {{$service_purpose->service_req_meeting_frend->frnd_state == $v->state_id ? "selected" : ''}}>{{$v->state_name}}</option>
                                            @endforeach
                                        </select>
                                        <i class="fa fa-angle-down"></i>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        ...
                                        <input type="text" name="service_req_recruit_manpower[recruit_name_contact]" value="{{$service_purpose->service_req_recruit_manpower->recruit_name_contact}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>Nature of Job for which recruiting</label>
                                        <input type="text" name="service_req_recruit_manpower[recruit_nature_job]" value="{{$service_purpose->service_req_recruit_manpower->recruit_nature_job}}" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="__app_input">
                                        <label>Places where recruitment is to be conducted</label>
                                        <input type="text" name="service_req_recruit_manpower[recruit_place]" value="{{$service_purpose->service_req_recruit_manpower->recruit_place}}" />
                                    </div>
                                </div>
                                @endif
                                        ...
                                        <div class="doc-head">{{str_replace('_', ' ', $v->doc_type)}}</div>
                                             ...
                                             <div class="fileinput fileinput-exists input_hide" data-provides="fileinput">
                                                ...
                                                <div>
                                                   ...
                                                   <input type="file" name="{{strtolower($v->doc_type)}}" accept="image/jpeg">
                                                   </span>
                                ...
                                <div class="col-md-4">
                                    <div class="__app_input">
                                      ...
                                      <label>{{str_replace('_', ' ', $document->doc_type)}}</label>
                                        <input type="file" name="{{strtolower($document->doc_type)}}" class="input_hide" accept="application/pdf">
                                        <span><a href="{{URL::to('/').$document->doc_url}}" class="input_hide">{{str_replace('_', ' ', $document->doc_type)}}</a></span>
