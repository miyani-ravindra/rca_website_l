...
<html>
  ...
  <body onload="submitPayuForm()">
    ...
    <div class="__loader_box"> <div class="__loader_body">
    <img src="{{ URL::to('/') }}/images/Loading.gif" alt="processing" class="img-responsive" width="120" />
    </div> </div>
    <br/> 
    ...
    <form action="https://secure.payu.in/_payment" method="post" name="payuForm">
      ...
      <input type="hidden" name="surl" value="https://www.redcarpetassist.com/payment-success">
      <input type="hidden" name="furl" value="https://www.redcarpetassist.com/payment-fail">
      <input type="hidden" name="curl" value="https://www.redcarpetassist.com/payment-cancel">
