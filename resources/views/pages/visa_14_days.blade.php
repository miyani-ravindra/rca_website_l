    ...
    <div class="container container-sm __bg_txt">
        <div class="row">
            <div class="col-md-8 __inner_bg_txt">
                <h1 class="__bg_heading">14 Days - Short Term Visa <span>&#8377; {{ $visa_14_days }}</span></h1>
                <ul class="__list">
        ...
        <div class="col-md-12 __visa_container">
            <div class="col-md-8 padding0">
                ...
                <div id="tab-1" class="tab-content current">
                    <p>14 Days Dubai Visa is a short term Single Entry Visa. This type of visa is preferred by travellers visiting UAE for a short-term holiday, business or training purposes.</p>
                    <p>This visa is valid for 14 days from the date of issue and it allows you to stay in UAE for a maximum period of 14 days from the date of entry.</p>
                ...
                <div id="tab-2" class="tab-content">
                    <ul class="__list">
                        ...
                        <p><strong>The passport must be valid for a minimum of six months from the date of travel.</strong></p>
                        <li><strong>Photograph</strong>- Clear scanned colour copy of your passport size photograph.</li>
                        <li><strong>Address Proof</strong>- Any one clear scanned colour copy of your recent utility bill such as electricity, gas or phone bill.You can submit your rent / lease agreement if you stay in a rented accommodation.</li>
