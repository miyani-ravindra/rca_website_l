        ...
        <div class="container container-sm __bg_txt">
            <div class="row">
                <div class="col-md-8 __inner_bg_txt">
                    <h1 class="__bg_heading">90 Days Dubai tourist visa <span>&#8377; {{ $visa_90_days }}</span></h1>
                    <ul class="__list">
                        <li>All inclusive Price</li>
                        <li>Visa within 2-3 days</li>
                        <li>58 days validity</li>
                    </ul>
                    <button type="button" class="__btn" data-trigger="cart-modal" data-id="4">BOOK NOW</button>
                </div>
                <div class="col-md-4">
        ...
        <div class="col-md-12 __visa_container">
            <div class="col-md-8 padding0">
                ...
                <div id="tab-1" class="tab-content current">
                    <p>90 Days Dubai Tourist Visa is Single Entry Visa. This type of visa is preferred by travellers visiting UAE for long term holiday or stay with family and friends etc.</p>
                    <p>This visa is valid for 58 days from the date of issue, while it allows you to stay in UAE for a maximum period of 90 days form the date of entry.</p>
                    ...
                    <div class="__card_body">
                        <div class="__assistance_wrapper">
                            <div class="__assist_icon">
                                <img src="{{ URL::to('/') }}/{{ URL::to('/') }}/svg/assistance-icon.svg" alt="" class="img-responsive" />
                            </div>
