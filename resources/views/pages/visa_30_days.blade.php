    ...
    <div class="container container-sm __bg_txt">
            <div class="row">
                <div class="col-md-8 __inner_bg_txt">
                    <h1 class="__bg_heading">30 Days dubai tourist visa <span>&#8377; {{ $visa_30_days }}/-</span></h1>
                    <ul class="__list">
            ...
            <div class="col-md-12 __visa_container">
                <div class="col-md-8 padding0">
                    ...
                    <div id="tab-1" class="tab-content current">
                        <p>The 30-Day Visa allows you to enter Dubai and UAE and enjoy the beautiful country for up to 30 Days. The 30-Day Visa is the most popular Visa and ideal for long holidays in Dubai and UAE. This is a single entry visa, which means that a person entering UAE on this Visa cannot enter again on the same Visa. Typically, you will need to travel to the UAE within 58 days of the issuance of the 30-Day Visa.</p>
                        ...
                        <ul class="__list_numb">
                            ...
                            <li>96 hours UAE visa are specifically applicable to applicants transiting through Dubai Insternational Airport</li>
                    ...
                    <div id="tab-2" class="tab-content">
                        <ul class="__list">
                            <li>A confirmed return airline ticket.</li>
                            <li>One Coloured photo, size 4.3 cms x 5.5 cms preferably white background and matt finish</li>
                            <li>Coloured photocopies of the First and the Last two pages of your Passport. Observation Page – if any, valid travel records – if any). The Passport should be valid for atleast six months from the date of travel.</li>
                            <li>We are required to ask for a copy of the Aadhaar card/MTNL bill/Electricity bill/ OR office visiting card as an additional verification document to avoid any absconding cases.</li>
                            <li>Other documents as per the supporting criteria I/II/III</li>
                        </ul>
                    </div>
                    <div id="tab-3" class="tab-content">
                        <p>Usually, it will take 4 – 5 working days from the date of submission. Since UAE is closed on Friday &amp; Saturday and India is closed on Sunday, processing your Visa over the weekend may take longer. Visa Processing time during peak seasons like Dubai Shopping Festivals may also take longer.</p>
                    </div>
                ...
                <aside class="col-md-4">
                        ...
                        <div class="__card_body">
                            <div class="__assistance_wrapper">
                                <div class="__assist_icon">
                                    <img src="{{ URL::to('/') }}/svg/assistance-icon.svg" alt="" class="img-responsive" />
                                </div>
                    ...
                    <div class="__card __fast_visa">
                        <div class="__card_body">
                            <div class="__assistance_wrapper">
                                ...
                                <div class="__assist_icon">
                                    <img src="{{ URL::to('/') }}/svg/fastest-icon.svg" alt="" class="img-responsive" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="__customer_love">
                        ...
                        <a href="#"><img src="{{ URL::to('/') }}/images/review_google.png" alt="" width="100"></a>
                        <a href="#"><img src="{{ URL::to('/') }}/images/review_facebook.png" alt="" width="100"></a>
                    </div>
                </aside>
                <!-- Aside End -->
