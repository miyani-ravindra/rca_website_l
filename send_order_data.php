<?php
   ...
   function call($method, $parameters, $url)
   {
    ...
    $qry = "select ap.profile_id, od.order_code, od.product_id, pm.product_name, od.applicant_booking_status,od.travel_to, od.arrival_date, 
                ...
                ap.previous_name, ap.previous_surname, od.order_id, ap.dob, ap.gender, ms.marital_status_code, ap.nationality, ap.place_of_birth, ap.country_of_birth, ap.religion, ap.mobile_number, users.email_id,
                ...
                left join passport_details pd on pd.id = ap.passport_detail_id
    ...
    foreach ($res as $key => $value) {
        ...
        $if_prev_name ="N";
        if(!empty($value['previous_surname']) && !empty($value['previous_name'])){
            $if_prev_name ="Y";
        }
        ...
        $arrayvar=array(
            ...
            "student_guardian_c" => $value['oth_occ_flag'],
            ...
            "prev_nationality_c" => $value['prev_nationality'],
            ...
            "place_to_visit_1_c" => $value['service_req_form_values'],
            "place_to_visit_2_c" => $value['service_req_form_values2'],
